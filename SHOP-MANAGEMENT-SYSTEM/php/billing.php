                ...
                <table>
                    ...
                    <tbody>
                        <?php
                            if ($_SERVER["REQUEST_METHOD"] == "POST" || $_SERVER["REQUEST_METHOD"] == "GET"){
                                if(isset($id)){
                                    $sql = "CREATE OR REPLACE VIEW temperory AS SELECT p.product_name as product,o.quantity as qty,o.subtotal as subtot,p.price as price,p.price*o.quantity as price_amt,
                                        p.tax as tax,p.tax * o.quantity as tax_amt 
